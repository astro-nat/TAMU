...
{
	int int_var; 
	//Tag 1 - This declares a variable of type int. 
	//This is to store bit and byte values for sizeof functions below.
	...
	//Tag 2 - The sizeof functions replace "%d" with the associated value in order from left to right.
	//The int_var variable is declared above.
