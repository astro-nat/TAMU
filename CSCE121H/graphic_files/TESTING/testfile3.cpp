...
struct Movie_window : Graph_lib::Window {       // inherits from Window

  // constructor
  Movie_window(Point xy,             // top lefthand corner
	       int w,                // width
	       int h,                // height
...
// ----------------------------------------------------------
// now define the parts of Movie_window that were only declared
// inside the class
...
int main() 
  try {
    ...
    Movie_window win(Point(100,100),600,400,"lines");
